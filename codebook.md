...
Here is a list of variables for the measurements:
...
These data sets were used to extract mean, standard deviation for various test subjects.

The results were outputted at ./data/TidyDataSet.txt
